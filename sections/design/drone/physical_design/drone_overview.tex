...
The Drone is a quadcopter constructed from a combination of standard, commercially available components and custom-fabricated parts. \autoref{fig:drone_electronics} provides a high-level view of its onboard electronics architecture and subsystem interfaces.
