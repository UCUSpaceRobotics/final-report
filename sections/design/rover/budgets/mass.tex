...
\begin{table}[!t]
\centering
\caption{Rover mass budget -- mobile platform and electronics }
...
\begin{table}[!t]
\centering
\caption{Rover mass budget -- manipulator arm and science station }
...
): base rover configuration 35.7 kg, electronics 13.3 kg, manipulator arm 8.8 kg, exploration cameras 0.16 kg, sample end-effector 1.54 kg, container system 1.6 kg, astrobio end-effector 0.7 kg, landing platform 0.8 kg (Placeholder).
