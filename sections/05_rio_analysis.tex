...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.9\linewidth, height=0.45\textheight, keepaspectratio]{figures/risk_trend_chart}
    \caption{Risk Index trend, Preliminary $\to$ Final Report (placeholder)}\label{fig:risk_trend_chart}
\end{figure}

\todo[inline]{Placeholder image - Phase 2/4: draw the real trend chart
outside \LaTeX\ (style: ECSS-M-ST-80C Fig.~5-7) and export it to replace
\autoref{fig:risk_trend_chart}, with RI values per phase: Preliminary
$\to$ Final. Preliminary baseline: R-01:16, R-02:12, R-03:12, R-04:10,
R-05:9, R-06:9, R-07:9, R-08:8, R-09:6, R-10:6.}
